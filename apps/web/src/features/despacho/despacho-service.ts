import type { Despacho, DespachoChecklist, PalletDespacho, PlanPalletizacion } from '@soschoco/shared';
...
export function iniciarCarga(request: Peticion, orgId: string, despachoId: string, viajeId?: string) {
